    ...
    return (
        <>
                    ...
                    <div className="flex flex-row items-center cursor-pointer pl-4">
                        ...
                        <div onClick={() => dispatch(logout())}>
                            <Tooltip content="Sign Out" placement="bottom">
                                <p className="font-inter cursor-pointer text-sm font-medium tracking-normal leading-none">
                                    Giriş Yap {name.charAt("0").toUpperCase() + name.slice(1)}
                                </p>
                            </Tooltip>
                        </div>
                    </div>
            ...
            <div className="bg-black p-4 w-full flex items-center justify-center mx-auto">
                <p className="text-white font-inter text-base font-medium ">50% İNDİRİM</p>
